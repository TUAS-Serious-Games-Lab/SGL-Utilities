...
namespace SGL.Utilities.TestUtilities.XUnit {
	/// <summary>
	/// Provides a variation of the regular <see cref="TheoryAttribute"/> that allows specifying a predicate in the form of a <see cref="Type"/> and the name of a static method on that type.
	...
	/// </summary>
	public class ConditionallyTestedTheoryAttribute : TheoryAttribute {
		/// <summary>
		...
		public ConditionallyTestedTheoryAttribute(Type predicateType, string predicateMethod) : this(predicateType, predicateMethod, "Test run predicate returned false.") { }
		/// <summary>
		/// Constructs an attribute object with the given data.
		/// </summary>
		/// <param name="predicateType">The type that contains the static predicate method.</param>
		...
		public ConditionallyTestedTheoryAttribute(Type predicateType, string predicateMethod, string skipReason) {
